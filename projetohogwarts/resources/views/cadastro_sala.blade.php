                ...
                <div class = "div-borda">
                    ...
                    <form>                  
                        <div class="form-group">
                            ...
                            <input class="form-control tf-custom ipt" type="int" id="nome"name="codigo" size=20 placeholder="Digite o código da sala"required="" autofocus=""><br>
                            <label for="nome">Nome da Sala:</label>
                            <input class="form-control tf-custom ipt" type="text" id="nomesala"name="nomesala" size=30 placeholder="Digite o nome da sala"required="" autofocus=""><br>
