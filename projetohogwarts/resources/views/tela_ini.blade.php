        ...
        <div id="wrapper" class="toggled">
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    <li class="sidebar-brand"> <a href="/login"> Efetuar Login </a> </li>
                    <li> <a href="/cadastro/sala">Cadastro de Sala</a> </li>
                    <li> <a href="/cadastro/departamento">Cadastro de Departamento</a> </li>
